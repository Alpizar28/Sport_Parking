                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-1.5">
                                <label htmlFor="password" className="block text-sm font-bold text-muted-foreground uppercase text-xs tracking-wider">
                                    Contraseña
                                </label>
                                <Link href="/forgot-password" className="text-xs font-bold text-emerald-500 hover:text-emerald-400 transition-colors">
